    ...
    <main className="min-h-screen relative bg-black text-white z-2">
      ...
      <section className="pt-40 md:pt-50 pb-16 px-6 text-center">
        ...
        >
          ...
          <motion.h1
            variants={headerItemVariants}
            className="mb-5 text-5xl font-black tracking-tight text-white md:text-6xl lg:text-7xl"
          >
      ...
      <section className="px-6 pb-28">
        <motion.div
          ...
          transition={{ duration: 0.65, ease: EASE }}
          viewport={{ once: true }}
          className="mx-auto max-w-3xl rounded-3xl border border-white/8 bg-linear-to-br from-white/5 to-white/[0.02] p-12 text-center backdrop-blur-sm"
        >
          ...
          <div className="flex flex-col items-center justify-center gap-3 sm:flex-row">
            ...
            <Link
              href="/contact"
              className="flex items-center gap-2 rounded-sm border border-white/10 bg-white/5 px-6 py-3 text-sm font-semibold text-white transition-all hover:bg-white/10"
            >
              Talk to sales
            </Link>
          </div>
