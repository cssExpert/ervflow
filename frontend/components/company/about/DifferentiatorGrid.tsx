...
const FEATURES = [
  {
    ...
    description: "Generate complete, production-ready websites from simple text prompts in seconds — not days.",
  ...
  },
  {
    ...
    description: "Customize layouts, content, and styles with pixel precision — no code required for any of it.",
  ...
  },
  {
    ...
    description: "Export clean, maintainable code and integrate with modern development workflows seamlessly.",
  ...
  },
  {
    ...
    description: "Collaborate seamlessly across design, marketing, and development — all from a single platform.",
        ...
        >
          {FEATURES.map((f) => (
            <motion.div
              ...
              className="group h-full p-6 sm:p-8 rounded-2xl border border-zinc-800 bg-zinc-900 hover:border-zinc-600 cursor-default transition-colors duration-300"
            >
              <motion.div
