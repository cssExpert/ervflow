...
const EXPERTS: Expert[] = [
  { name: "Sophia Reeves", role: "UI/UX Designer", initials: "SR", gradient: "from-violet-500 to-purple-600", specialties: ["Design Systems", "Brand Identity", "Figma"], experience: 7, projects: 64, rating: 5.0, available: true, rate: "$110/hr" },
  { name: "Marcus Jensen", role: "Full-Stack Developer", initials: "MJ", gradient: "from-blue-500 to-cyan-600", specialties: ["Next.js", "API Integration", "Performance"], experience: 5, projects: 52, rating: 4.9, available: true, rate: "$95/hr" },
  { name: "Priya Malhotra", role: "AI Integration Specialist", initials: "PM", gradient: "from-emerald-500 to-teal-600", specialties: ["AI Workflows", "OpenAI", "Automation"], experience: 4, projects: 38, rating: 4.8, available: false, rate: "$120/hr" },
  { name: "Carlos Mendez", role: "SEO & Performance Expert", initials: "CM", gradient: "from-amber-500 to-orange-500", specialties: ["Core Web Vitals", "SEO Audit", "Analytics"], experience: 8, projects: 89, rating: 4.9, available: true, rate: "$85/hr" },
  { name: "Aisha Okonkwo", role: "Content Strategist", initials: "AO", gradient: "from-rose-500 to-pink-600", specialties: ["Copywriting", "Brand Voice", "CMS Setup"], experience: 6, projects: 71, rating: 4.7, available: true, rate: "$75/hr" },
  { name: "Raj Patel", role: "Migration Specialist", initials: "RP", gradient: "from-indigo-500 to-blue-600", specialties: ["Platform Migration", "Data Import", "WordPress"], experience: 5, projects: 45, rating: 4.8, available: false, rate: "$90/hr" },
];
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-3 gap-2 py-3 border-t border-b border-zinc-800 mb-4 text-center">
        <div>
          <p className="text-sm font-semibold text-zinc-100">{expert.experience}y</p>
          <p className="text-[10px] text-zinc-500 mt-0.5">Experience</p>
        </div>
        <div>
          <p className="text-sm font-semibold text-zinc-100">{expert.projects}</p>
        ...
        <div>
          <div className="flex items-center justify-center gap-1">
            ...
            <p className="text-sm font-semibold text-zinc-100">{expert.rating}</p>
          </div>
...
export default function ExpertDirectory() {
  return (
    <section id="directory" className="py-20 sm:py-28 bg-zinc-900/30 border-y border-zinc-800">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionReveal className="text-center mb-14">
          ...
          <p className="mt-4 text-base text-zinc-400 max-w-lg mx-auto">
            Every expert is individually vetted, certified, and trusted by ERVFlow.
          </p>
        </SectionReveal>
