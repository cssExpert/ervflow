  ...
  return (
    <TiltCard debugMode={debugMode} className="p-4 sm:p-8 flex flex-col h-full">
      <div className="space-y-2 mb-6">
        <span className="text-xs text-cyan-600 dark:text-cyan-400 bg-cyan-400/10 px-2 py-1 rounded">
          Module 01
        </span>
        ...
        <a
          ...
          className="inline-flex items-center gap-1 text-sm text-slate-600 dark:text-neutral-400 hover:text-slate-900 dark:hover:text-white transition-colors pt-2 group"
        >
          Learn more
      ...
      <div className="bg-slate-100 dark:bg-[#050505] rounded-[18px] border border-black/8 dark:border-white/5 p-4 sm:p-6 grow flex flex-col justify-between relative">
        <div>
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-base font-semibold tracking-wide text-slate-800 dark:text-neutral-200">
              Overview
            </h3>
            <div className="flex items-center gap-2 text-[11px] bg-slate-200 dark:bg-neutral-900 border border-black/8 dark:border-white/5 px-2 py-1 rounded text-slate-600 dark:text-neutral-400">
        ...
        <div className="mt-6 border-t border-black/8 dark:border-white/5 pt-4">
          <div className="flex items-center justify-between mb-3 text-xs text-slate-600 dark:text-neutral-400">
            <span className="font-medium">Sources</span>
            <span className="text-[10px]">Referrer</span>
          </div>
