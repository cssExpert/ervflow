...
function BentoCard({
  ...
  return (
    <div
      ...
      onTransitionEnd={() => {
        if (visible) setAnimDone(true);
      }}
      className={cn(
        "relative overflow-hidden group/bento",
        animDone && "transition-transform duration-220 ease-out",
        hoverClass,
        className,
      )}
      style={
  ...
  return (
    <section className="py-16 px-6 overflow-hidden">
      <div ref={headerRef} className="text-center mb-14 max-w-3xl mx-auto">
        <span
          className="mb-4 inline-flex items-center gap-2 bg-primary-500/10 border border-primary-500/20 text-primary-600 dark:text-primary-400 text-[11px] font-semibold px-4 py-1.5 rounded-full uppercase tracking-widest"
          style={fadeStyle(0)}
        >
          Testimonials
        </span>
